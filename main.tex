...
\documentclass[a4paper,10pt]{extarticle} % Default font size and paper size
  ...
  \normalsize \faGithub\ {\href{https://github.com/pshishod2645}{\  pshishod2645}}\\
  % \normalsize  \faLinkedinSquare\ {\href{https://www.linkedin.com/in/kousshik-raj-murali-b3976916a/}{\  Kousshik Raj}}\\
  \normalsize \faHome {\href{http://codeforces.com/profile/pshishod2645}{\ \space pshishod2645 (Codeforces)}}\\
  \normalsize \faHome {\href{https://www.codechef.com/users/pshishod2645}{\ \space pshishod2645 (CodeChef)}}\\
  \columnbreak
  \normalsize\par{\centering{\huge\textsc{\textcolor{primary}{Prashant Shishodia}\par} % Your name
  % \vspace{-0.6cm}
  \par{\centering\normalsize {\textsc{A-202, JCB Hall of Residence, }}\hfill\par}
  \vspace{-0.2cm}
  \par{\centering\normalsize {\textsc{IIT Kharagpur, WB, India - 721302 }}\hfill\par}
  
  \columnbreak
  \raggedright\hfill\normalsize \faEnvelope\ {\href{mailto:prashant.cse.iitkgp@gmail.com}{\  prashant.cse.iitkgp@gmail.com}}\\
  \raggedright\hfill{\faPhone\ \  +91-7060334547}
  \end{multicols}
